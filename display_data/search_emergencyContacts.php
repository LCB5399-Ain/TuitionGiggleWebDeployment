...
<head>
    ...
    <title>Search Emergency Contacts</title>
    ...
    <div class="container-box mt-2">
        ...
        <thead class="table-light">
            ...
            <tbody>
                ...
                $fetchQuery = "SELECT * FROM emergencycontacts ORDER BY fullName";
                ...
                if ($resultData && mysqli_num_rows($resultData) > 0) {
                    while ($row = mysqli_fetch_array($resultData)) {
                        ...
                        if ((int)$row['tuitionID'] == (int)$_SESSION['tuitionID']) {
                            ...
                            echo "<td>" . $row['emergencyContactID'] . "</td>";
                            ...
                            echo ("<td><a href=\"../delete_data/delete_emergencyContacts.php?emergencyContactID=".$row['emergencyContactID']."\">Delete</a></td>");
                            echo "</tr>";
                        }
                    }
                }
    ...
    <!-- End of adapted code -->
        ...
        <div class="row-btn-2">
            <div class="col-md-12 text-center">
                <a type="submit" class="btn" href="../insert_data/insert_emergencyContact.php">Add emergency contacts</a>
            </div>
        </div>
