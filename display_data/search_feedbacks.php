    ...
    <div class="container mt-2">
        <div class="col-10 col-md-6 mx-auto" style="padding: 2%;">
            <div class="form-box-cont">
                <h2 class="text-center">Find Feedback</h2>
    ...
    <div class="container-box mt-2">
        ...
        <thead class="table-light">
            ...
            <tbody>
                ...
                $fetchQuery = "SELECT * FROM feedback ORDER BY teacherName";
                ...
                if ($resultData && mysqli_num_rows($resultData) > 0) {
                    while ($row = mysqli_fetch_array($resultData)) {
                        ...
                        if ($row['tuitionID'] == (int)$_SESSION['tuitionID']) {
                            ...
                            echo "<td>" . $row['date_of_feedback'] . "</td>";
                            echo ("<td><a href=\"../edit_data/edit_feedbacks.php?feedbackID=".$row['feedbackID']."\">Edit</a></td>");
                            echo ("<td><a href=\"../delete_data/delete_feedbacks.php?feedbackID=".$row['feedbackID']."\">Delete</a></td>");
                            echo "</tr>";
                        }
                    }
                }
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a type="submit" class="btn" href="../insert_data/insert_feedback.php">Add a feedback</a>
            </div>
        </div>
...
<!-- Function for searching feedback's id -->
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
        ...
        searchInput.addEventListener("input", function() {
            ...
            if (query) {
                fetch('../search_data/search_feedback.php', {
                    method: 'POST',
                    headers: {
